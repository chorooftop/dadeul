CREATE TABLE "accounts" (
	...
	CONSTRAINT "accounts_access_token_unique" UNIQUE("access_token")
);
...
CREATE INDEX "accounts_access_token_idx" ON "accounts" USING btree ("access_token");--> statement-breakpoint
